...
public class TransactionController : ControllerBase
{
    ...
    // public async Task<ActionResult<TransactionDTO>> AddTransaction(int walletId, TransferRequestDTO transferRequest)
    // {
    //     try
    //     {
    //         if (transferRequest == null) transferRequest = new TransactionDTO();
            
    //         // Garante que o ID da rota seja usado
    //         transferRequest.WalletId = walletId;
    ...
    //             var transferResult = await _walletService.Transfer(transferRequest);
